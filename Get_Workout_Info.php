<?php
/*
	Description: Returns the days workout description. Takes username and date in YYYY-MM-DD format
	URL: http://proj-309-am-b-4.cs.iastate.edu/Get_Workout_Info.php?username=<USERNAME>&date=<DATE>
	Output: DESCRIPTION
		Werking on Monday
*/
